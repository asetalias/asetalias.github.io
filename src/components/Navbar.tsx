  ...
  return (
    ...
    <div style={navDiv}>
      ...
      <div className="navbar__logo">
        ...
        >
          <defs>
            ...
            >
              <stop offset={0} stopColor="#08b5ff" />
              <stop offset={1} stopColor="#1c1cd1" />
            </linearGradient>
            <linearGradient
          ...
          <g id="Group_1" data-name="Group 1" transform="translate(-260 -36)">
            ...
            <g
              id="right-hand"
              data-name="Group 24"
              transform="matrix(0.998, -0.07, 0.07, 0.998, -5.824, 24.42)"
            >
              <path
                id="Path-3"
                d="M3986.488,2635.52s-2.373,11.445,6.067,28.377,14.412,20.373,17.331,23.692,9.163,5.521,9.051,3.272c-.2-4.089-7.53-27.074-17.875-44.165S3986.488,2635.52,3986.488,2635.52Z"
                transform="matrix(0.999, 0.052, -0.052, 0.999, -3507.988, -2764.923)"
            ...
            <g id="Group_23" data-name="Group 23">
              <path
                id="Path_1"
                data-name="Path 1"
                d="M68.3,8C82.7,8.623,83.728,22.253,87,32c.033.09,5.877,21.286,5.877,25.973.5,3.977,2.681,17.26-3.234,26.518C85.853,91.285,79.881,96,68.3,96,46.943,96,44.034,85.308,39,72c-4.908,6.319-16,13.034-16,8,0-3.779,16.881-37.99,24-48C51.838,22.511,55.953,8.623,68.3,8Z"
              ...
              <line
                ...
                data-name="Line 1"
                y1={31}
                transform="translate(330.015 114)"
                fill="none"
                stroke="#fff"
              ...
              <line
                ...
                data-name="Line 2"
                x2={12}
                transform="translate(330.015 113)"
                fill="none"
                stroke="#fff"
                strokeLinecap="round"
                strokeWidth={2}
              ...
              <g
                id="Ellipse_2"
                data-name="Ellipse 2"
                transform="translate(339.015 110)"
                fill="#fff"
                stroke="#fff"
                strokeWidth={2}
              >
              ...
              <line
                ...
                data-name="Line 3"
                y1={20}
                transform="translate(336.015 124)"
                fill="none"
                stroke="#fff"
                strokeLinecap="round"
                strokeWidth={2}
              ...
              <g
                id="Ellipse_3"
                data-name="Ellipse 3"
                transform="translate(339.015 121)"
                fill="#fff"
                stroke="#fff"
                strokeWidth={2}
              >
              ...
              <line
                ...
                data-name="Line 5"
                y1={22}
                transform="translate(322.015 123)"
                fill="none"
                stroke="#fff"
                strokeLinecap="square"
                strokeWidth={2}
              ...
              <line
                ...
                data-name="Line 6"
                x1={6}
                transform="translate(316.015 122)"
                fill="none"
                stroke="#fff"
                strokeLinecap="round"
                strokeWidth={2}
              ...
              <g
                id="Ellipse_4"
                data-name="Ellipse 4"
                transform="translate(314.015 119)"
                fill="#fff"
                stroke="#fff"
                strokeWidth={2}
              >
      ...
      <div style={navItems}>
        ...
        <div className={navButton}>Events</div>
        {/* <Link to="#">About Us</Link> */}
